...
class _PersonalDataPageState extends State<PersonalDataPage> {
  ...
  // Function to generate a list of years from a starting year (current year - 100) until the current year
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField<int>(
                      ...
                      dropdownColor: const Color.fromARGB(255, 0, 22, 20),
                        ...
                        const Row(
                          children: [
                            Icon(Icons.info_outline,
                                color: Color.fromARGB(150, 0, 0, 0), size: 20),
                            SizedBox(
                              width: 8,
                            ),
                            Flexible(
